					    ...
					    <ul>
					      <li>
					        ...
					        <div class="item-content">
					          <div class="item-inner">
					            ...
					            <div class="item-subtitle col_4d">${bean.username }</div>
					          </div>
					        </div>
					        </a>
					      </li>
					      <li>
					        ...
					        <div class="item-content">
					          <div class="item-inner">
					            ...
					            <div class="item-subtitle col_4d">${bean.phone }</div>
					          </div>
					        </div>
					        </a>
					      </li>
					      <li>
					        ...
					        <div class="item-content">
					          <div class="item-inner">
					            <div class="item-title-row">
					              <div class="item-title col_cc">编号</div>
					            </div>
					            <div class="item-subtitle col_4d">${bean.codeinfo }</div>
					          </div>
					        </div>
					        </a>
					      </li>
