							...
							<div class="item-content">
								...
								<div class="item-inner">
									<div class="item-title-row">
										<div class="item-title col_66">{{=it[bean].alias}}</div>
									</div>
									<div class="item-subtitle col_83">
										<span>上传时间:</span><span>{{=it[bean].examtime}}</span>
									</div>
								</div>
							</div>
						</a>
...
<body>
		...
		<div class="page-group">
			<div id="exam_Arrangement" class="page">
				<header class="bar bar-nav header_bg"> <a
					...
					<h1 class="title col_w">课程列表</h1>
				 	<a href="${ctx }/exam/toadd?classId=${classId}" class="button button-link button-nav pull-right col_w">新增考试安排</a>
				</header>
