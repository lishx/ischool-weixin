					...
					<ul>
						...
						<li><a href="">
								<div class="item-content">
									<div class="item-inner">
										<div class="item-title-row">
											<div class="item-title col_cc">完成时间</div>
										</div>
										<div class="item-subtitle col_4d">${entity.examtime }
											至${entity.endtime }</div>
									</div>
								</div>
						</a></li>
						<li><a href="">
								<div class="item-content">
									<div class="item-inner">
										...
										<div class="item-subtitle col_4d">${entity.examreq }</div>
									</div>
								</div>
						</a></li>
						<li><a href="">
								<div class="item-content">
									<div class="item-inner">
										...
										<div class="item-subtitle col_4d">${entity.address }</div>
									</div>
								</div>
						</a></li>
					</ul>
